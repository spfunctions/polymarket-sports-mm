...
Sports market making bot for [Polymarket](https://polymarket.com) liquidity rewards. Optimized for the quadratic scoring function.
...
Built with [SimpleFunctions](https://simplefunctions.dev) — prediction market intelligence for AI agents.
